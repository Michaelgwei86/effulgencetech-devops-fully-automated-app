...
1) ###### GitHub setup
    Fork GitHub Repository by using the existing repo "devops-fully-automated" (https://github.com/Michaelgwei86/effulgencetech-devops-fully-automated-app)     
    - Go to GitHub (github.com)
    - Login to your GitHub Account
    - **Fork repository "effulgencetech-devops-fully-automated-app" (https://github.com/Michaelgwei86/effulgencetech-devops-fully-automated-app) & name it "effulgencetech-devops-fully-automated-app"**
